  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col p-8 sm:p-12 md:p-16 lg:p-24 justify-center relative z-10">
        ...
        <div className="absolute top-8 left-8 right-8 sm:top-12 sm:left-12 sm:right-12 flex justify-between items-center z-10">
          <Link href="/" className="flex items-center gap-3 group">
            
            {/* Removed the extra wrapper divs! Just the raw image now. */}
            <img
        ...
        <div className="max-w-md w-full mx-auto mt-16 lg:mt-6">
          ...
          {displayError && (
            <div
              className={`mb-6 p-4 rounded-xl text-sm font-semibold flex items-start gap-3 transition-colors ${isDark ? "bg-red-500/10 border border-red-500/20 text-red-400" : "bg-red-50 border border-red-200 text-red-600"}`}
            >
              <div
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Mail
                    className={`h-5 w-5 transition-colors ${isDark ? "text-white/40" : "text-stone-400"}`}
                  />
                </div>
                <input
                  name="email"
            ...
            >
              {loading ? (
                <span className="flex items-center gap-2">
                  <svg
                    className={`animate-spin h-5 w-5 ${isDark ? "text-black" : "text-white"}`}
